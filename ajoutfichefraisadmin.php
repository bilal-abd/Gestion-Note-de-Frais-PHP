...
<head>
    ...
    <title>Ajout fiche de frais admin</title>
</head>
<body>
    ...
    <ul class="navbar-nav ms-auto">
      ...
      <li class="nav-item">
        ...
        <h1 class="titre_fiche">FICHE DE FRAIS</h1>
			<HR>
        <h2>Ajouter vos fiches de frais</h2>
            <div id="volet_clos">
	    <div id="volet">
...
<center><b class="intro">Nom : <input class="nom" type="text" name="nom" placeholder="Entrez votre nom"></b></center><br> 
